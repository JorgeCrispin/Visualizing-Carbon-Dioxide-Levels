...
geom_line()+
labs(title= "Carbon Dioxide Levels From 8,000 to 136 Years BP", subtitle="From World Data Center for Paleoclimatology and NOAA Paleoclimatology Program")+
labs(x="Years Before Today(0=1950)", y="Carbon Dioxide Level (Parts Per Million)")+
...
geom_line()+
labs(title = "Carbon Dioxide Levels over Time", subtitle = "From Institute for Atmospheric and Climate Science (IAC).")+
labs(x="Year", y="Carbon Dioxide Level (Parts Per Million)")+
